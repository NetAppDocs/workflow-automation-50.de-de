...
`wfa_server_ip` Ist die IP-Adresse Ihres WFA-Servers und _Port_ ist die TCP-Portnummer, die Sie für den WFA-Server während der Installation verwendet haben.
